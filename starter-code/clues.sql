...
select * from country where name = 'Holy See (Vatican City State)'; #find the countrycode
select language from countrylanguage where countrycode = 'VAT'; #find the offical language

-- Clue #3: We have new news on the classes Carmen attended – our gumshoes tell us she's moved on
-- to a different country, a country where people speak only the language she was learning. Find out which
--  nearby country speaks nothing but that language.

select percentage, countrycode from countrylanguage where language = 'Italian';
...
-- She's in _______Santa Monica, CA_____________________!
